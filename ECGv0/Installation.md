...
6. In the build configuration, select `nrf5340dk/nrf5340/cpuapp` as the board target. Use `prj.conf` as the application configuration file; the board files are selected automatically.
