...
#define GLOBAL_TICK_HZ 512U
#define IMU_RTC_TICK_HZ GLOBAL_TICK_HZ
#define IMU_RTC_PRESCALER ((32768U / IMU_RTC_TICK_HZ) - 1U)
#define IMU_RTC_IRQ_PRIORITY IRQ_PRIO_LOWEST
#define IMU_FIXED_INPUT_HZ GLOBAL_TICK_HZ
#define IMU_FIXED_OUTPUT_HZ 32U
#define IMU_FIXED_ACCUM_SAMPLES (IMU_FIXED_INPUT_HZ / IMU_FIXED_OUTPUT_HZ)
#define IMU_FIXED_ACCEL_REPORT_DIVISOR IMU_FIXED_ACCUM_SAMPLES
#define IMU_FIXED_ACCEL_REPORT_HZ (GLOBAL_TICK_HZ / IMU_FIXED_ACCEL_REPORT_DIVISOR)
#define IMU_FIXED_ACCEL_SMPLRT_DIV 0x0001U
#define IMU_FIXED_ACCEL_SMPLRT_DIV_MSB ((IMU_FIXED_ACCEL_SMPLRT_DIV >> 8) & 0xFF)
#define IMU_FIXED_ACCEL_SMPLRT_DIV_LSB (IMU_FIXED_ACCEL_SMPLRT_DIV & 0xFF)
#define IMU_FIXED_GYRO_SMPLRT_DIV 0x01U
#define IMU_FIXED_GYRO_DLPFCFG GYRO_DLPFCFG_151HZ
#define IMU_FIXED_ACCEL_DLPFCFG ACCEL_DLPFCFG_246HZ
#define MAGNETO_SAMPLING_RATE 32U
#define GYRO_SAMPLING_RATE GLOBAL_TICK_HZ
