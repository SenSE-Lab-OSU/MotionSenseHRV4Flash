...
4. Run `git apply /path/to/this/repo/MSenseDevice/msense_ncs_v2.9.3.patch`
5. Using visual studio, click on the nrf connect tab. Make sure you've selected the v2.9.3 sdk. If everything has installed properly and the SDK is chosen, you should see a button that says 'Open an Existing Application' within the 'Welcome' Tab. After pressing this, navigate to the repository folder 'MSenseDevice' with the opened file explorer.
